...
public final class PostgresV23FormulaResultLiveSelfTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        require(schemaVersion >= 23,
                "V23 Formula live test requires schema version 23 or newer, found " + schemaVersion);
        ...
        System.out.println(
                "PostgresV23FormulaResultLiveSelfTest: PASS schema=" + schemaVersion
