...
replace_once(
    ...
    """        artifactButton('Download method admission', run.methodAdmission, `rbvm-method-admission-${runId}-${analysisId}.json`), persistCanonicalPriority, close""",
